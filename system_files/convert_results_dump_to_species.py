...
# global parameters
agents, agent, left, right, comp, sites = ['A', 'T', 'C', 'G'], 2, 5, 7, 9, 12
nuc = {0: 'A', 1: 'T', 2: 'C', 3: 'G'}


def convert_dump_to_species(inputfile_path, des_path, filename, convert_type):
    try:
        def uni(dumpfile):
            ...
            li = (values[i:i+sites] for i in range(0, len(values), sites))
